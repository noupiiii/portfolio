...
export default function Footer() {
    return (
        <footer className="bg-[#FAF1E6] text-[#08553d] border-t border-[#08553d]/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col space-y-2">
                            <Link href="#about" className="text-sm sm:text-base text-[#08553d]/80 hover:text-[#08553d] transition-colors duration-300">
                                About
                            </Link>
                            <Link href="#education" className="text-sm sm:text-base text-[#08553d]/80 hover:text-[#08553d] transition-colors duration-300">
                                Education
                            </Link>
                            <Link href="#projects" className="text-sm sm:text-base text-[#08553d]/80 hover:text-[#08553d] transition-colors duration-300">
                                Projects
                            </Link>
                            <Link href="#contact" className="text-sm sm:text-base text-[#08553d]/80 hover:text-[#08553d] transition-colors duration-300">
                                Contact
                            </Link>
                        </div>
                    </div>
